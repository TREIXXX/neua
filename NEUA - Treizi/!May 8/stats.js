...
doc.text(`As of ${currentDate}`, 105, 28, { align: 'center' });
    ...
    fetchAdditionalStats().then(additionalData => {
        ...
        doc.text(`Released Documents: ${totalDocs}`, 85, yPos + 15);
        ...
        doc.autoTable({
            startY: yPos,
            head: [
                [{ content: 'MOST BORROWED DOCUMENTS (ALL TIME)', colSpan: 3, styles: { 
                    halign: 'center', 
                    fillColor: null, 
                    textColor: [0, 0, 0], 
                    fontStyle: 'bold',
        ...
        doc.autoTable({
            startY: yPos,
            head: [
                [{ content: 'MOST BORROWED DOCUMENTS (LAST 30 DAYS)', colSpan: 3, styles: { 
                    halign: 'center', 
                    fillColor: null, 
                    textColor: [0, 0, 0], 
                    fontStyle: 'bold',
