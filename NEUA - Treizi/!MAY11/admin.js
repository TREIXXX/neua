    ...
    records.forEach((record, index) => {
        ...
        switch (tableId) {
            ...
            case 'returnedDocsTable':
                ...
                if (record.status === 'Returned') {
                    returnedActionsCell.innerHTML = `
                        <div class="actions-dropdown">
                            ...
                            <div class="actions-menu">
                                <div class="action-item" onclick="markAsDamaged('${record.referenceNo}')">
                ...
                } else if (record.status === 'Damaged' || record.status === 'Missing') {
                    returnedActionsCell.innerHTML = `
                        <div class="actions-dropdown">
                            <button class="btn btn-sm" onclick="toggleActionsMenu(this)">
                                <i class="fas fa-ellipsis"></i>
    ...
    if (tableId === 'fileRecordsTable') {
        ...
        fields.forEach((field, index) => {
            ...
            if (input) {
                ...
                cells[cellIndex].setAttribute('title', 'Click to copy');
