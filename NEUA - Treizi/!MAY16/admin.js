        ...
        records.sort((a, b) => {
            ...
            switch (tableId) {
                ...
                case 'userRecordsTable':
                    ...
                    // Special case for userType column (usually index 4)
                    if (columnIndex === 4) {
                        // Sort by role priority instead of alphabetically
                        const aPriority = getUserTypePriority(aValue);
                        const bPriority = getUserTypePriority(bValue);
                        return nextState === 'asc' ? aPriority - bPriority : bPriority - aPriority;
                    }
                    break;
...
function redirectToHome() {
    ...
    // Get user type, department and name from PHP session
    fetch('get_user_type.php')
        ...
        .then(data => {
            ...
            sessionStorage.setItem('user_name', data.name || 'User');
