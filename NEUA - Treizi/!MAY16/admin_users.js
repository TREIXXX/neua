...
function updateDisapprovedUsersPagination() {
    ...
    // Previous button with new icon
    paginationHTML += `<button class="page-btn ${disapprovedCurrentPage === 0 ? 'disabled' : ''}" ${disapprovedCurrentPage === 0 ? 'disabled' : ''} onclick="changePagination('disapprovedUsersTable', ${disapprovedCurrentPage - 1})"><i class="fa-solid fa-chevron-left"></i></button>`;
    ...
    for (let i = startPage; i <= endPage; i++) {
        paginationHTML += `<button class="page-btn ${i === disapprovedCurrentPage ? 'active' : ''}" onclick="changePagination('disapprovedUsersTable', ${i})">${i + 1}</button>`;
    }
    
    // Next button with new icon
    paginationHTML += `<button class="page-btn ${disapprovedCurrentPage === totalPages - 1 ? 'disabled' : ''}" ${disapprovedCurrentPage === totalPages - 1 ? 'disabled' : ''} onclick="changePagination('disapprovedUsersTable', ${disapprovedCurrentPage + 1})"><i class="fa-solid fa-chevron-right"></i></button>`;
...
function updateDeactivatedUsersPagination() {
    ...
    // Previous button with new icon
    paginationHTML += `<button class="page-btn ${deactivatedCurrentPage === 0 ? 'disabled' : ''}" ${deactivatedCurrentPage === 0 ? 'disabled' : ''} onclick="changePagination('deactivatedUsersTable', ${deactivatedCurrentPage - 1})"><i class="fa-solid fa-chevron-left"></i></button>`;
    ...
    // Next button with new icon
    paginationHTML += `<button class="page-btn ${deactivatedCurrentPage === totalPages - 1 ? 'disabled' : ''}" ${deactivatedCurrentPage === totalPages - 1 ? 'disabled' : ''} onclick="changePagination('deactivatedUsersTable', ${deactivatedCurrentPage + 1})"><i class="fa-solid fa-chevron-right"></i></button>`;
